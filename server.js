...
const server = http.createServer(async (req, res) => {
  try {
    ...
    if (url.pathname === '/api/health') return sendJson(res, 200, {
      ok: true, app: 'range-operation-platform', version: '2.0.10', storage: DB_FILE,
...
server.listen(PORT, '0.0.0.0', () => console.log(`Range Operation Platform v2.0.10 listening on ${PORT} · SQLite ${DB_FILE}`));
