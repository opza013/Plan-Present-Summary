# Range Operation Platform v2.0.18 — Integrated Control Tower
...
## v2.0.13
- Edit Plan Item field order: Workstream → Milestone → Task → Sub-Task.
- Task and Sub-Task are optional free-form fields.
